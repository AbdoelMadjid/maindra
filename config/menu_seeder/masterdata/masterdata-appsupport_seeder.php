...
return [
    ...
    'children' => [
        ...
        [
            ...
            'title_en' => 'Import Master Data',
            'title_key' => 'md_impor_data_master',
            'route' => 'appsupport/impor-data-master',
            'permissions' => ['read'],
            'roles' => ['admin'],
        ],
        [
            'title' => 'Ekspor Data Master',
            'title_en' => 'Export Master Data',
            'title_key' => 'md_ekspor_data_master',
            'route' => 'appsupport/ekspor-data-master',
            'permissions' => ['read'],
            'roles' => ['admin'],
        ],
        [
